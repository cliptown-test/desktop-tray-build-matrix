...
if (plan.schemaVersion !== 1 || plan.repository !== 'desktop-tray-build-matrix') {
...
if (plan.security?.capturesClipboardData !== false) {
  throw new Error('This build harness must not capture clipboard data.');
}
...
console.log('desktop tray build matrix plan is valid');
